!function (e, t) {
    ...
    var n = [], T = w.document, c = n.slice, g = n.concat, a = n.push, i = n.indexOf, r = {}, o = r.toString,
        h = r.hasOwnProperty, v = {}, s = "2.2.4", C = function (e, t) {
    ...
    var d = function (n) {
        ...
        var e, h, b, o, r, g, p, v, w, u, l, T, C, i, k, m, s, a, y, E = "sizzle" + +new Date, x = n.document, N = 0,
            c = 0, d = ie(), S = ie(), j = ie(), D = function (e, t) {
                return e === t && (l = !0), 0
            ...
            W = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]",
            $ = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)",
            B = new RegExp(M + "+", "g"), _ = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
            X = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
            U = new RegExp("=" + M + "*([^\\]'\"]*?)" + M + "*\\]", "g"), V = new RegExp($),
            Y = new RegExp("^" + I + "$"), G = {
                ID: new RegExp("^#(" + I + ")"),
                CLASS: new RegExp("^\\.(" + I + ")"),
                TAG: new RegExp("^(" + I + "|[*])"),
        ...
        function ve(d, h, g, v, m, e) {
            return v && !v[E] && (v = ve(v)), m && !m[E] && (m = ve(m, e)), oe(function (e, t, n, r) {
                var i, o, s, a = [], u = [], l = t.length, c = e || function (e, t, n) {
                        ...
                        return n
                    }(h || "*", n.nodeType ? [n] : n, []), f = !d || !e && h ? c : ge(c, a, d, n, r),
                    p = g ? m || (e ? d : l || v) ? [] : t : f;
    ...
    var s = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, _ = new RegExp("^(?:([+-])=|)(" + s + ")([a-z%]*)$", "i"),
    ...
    C.event = {
        ...
        dispatch: function (e) {
            e = C.event.fix(e);
            var t, n, r, i, o, s = c.call(arguments), a = (R.get(this, "events") || {})[e.type] || [],
    ...
    var ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ue = /<script|<style|<link/i,
        le = /checked\s*(?:[^=]|=\s*.checked.)/i, ce = /^true\/(.*)/, fe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    var ke, Ee, Ne, Se, je, De, Ae = /^margin/, qe = new RegExp("^(" + s + ")(?!px)[a-z%]+$", "i"),
    ...
    var Pe = /^(none|table(?!-c[ea]).+)/, Re = {position: "absolute", visibility: "hidden", display: "block"},
        Me = {letterSpacing: "0", fontWeight: "400"}, Ie = ["Webkit", "O", "Moz", "ms"],
    ...
    function Xe(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = Te(e),
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, r) {
            var i, o, s, a, u, l, c = [n || T], f = h.call(e, "type") ? e.type : e,
                p = h.call(e, "namespace") ? e.namespace.split(".") : [], d = o = n = n || T;
    ...
    var dt = /#.*$/, ht = /([?&])_=[^&]*/, gt = /^(.*?):[ \t]*([^\r\n]*)$/gm, vt = /^(?:GET|HEAD)$/, mt = /^\/\//,
        yt = {}, xt = {}, bt = "*/".concat("*"), wt = T.createElement("a");
    ...
    wt.href = ct.href, C.extend({
        ...
        ajax: function (e, t) {
            ...
            var u, l, c, n, f, p, r, d = C.ajaxSetup({}, t = t || {}), h = d.context || d,
                g = d.context && (h.nodeType || h.jquery) ? C(h) : C.event, v = C.Deferred(),
                m = C.Callbacks("once memory"), y = d.statusCode || {}, i = {}, o = {}, x = 0, s = "canceled", b = {
