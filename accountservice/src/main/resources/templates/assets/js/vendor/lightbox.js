    ...
    return function l(i, o, d) {
        ...
        1: [function (e, t, s) {
            !function (e, t) {
                ...
                var d = {
                    wrap: function (e, t) {
                        ...
                        e && (t = new CustomEvent(t, {detail: 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null}), e.dispatchEvent(t))
                    }, Listener: {uid: 0}, on: function (s, e, l) {
                        ...
                        if (e && (s = e.getAttribute("lg-event-uid"))) for (var s = s.split("&"), l = 0; l < s.length; l++) if (s[l]) {
                            var i = t + s[l];
                            if ("." === i.substring(0, 1)) for (var o in d.Listener) d.Listener.hasOwnProperty(o) && -1 < o.split(".").indexOf(i.split(".")[1]) && (e.removeEventListener(o.split(".")[0], d.Listener[o]), e.setAttribute("lg-event-uid", e.getAttribute("lg-event-uid").replace("&" + s[l], "")), delete d.Listener[o]); else e.removeEventListener(i.split(".")[0], d.Listener[i]), e.setAttribute("lg-event-uid", e.getAttribute("lg-event-uid").replace("&" + s[l], "")), delete d.Listener[i]
                        }
                    }, param: function (t) {
            ...
            l = this, i = function (e) {
                ...
                var h = (e = e) && e.__esModule ? e : {default: e}, s = Object.assign || function (e) {
                ...
                "function" == typeof window.CustomEvent || (t.prototype = window.Event.prototype, window.CustomEvent = t), window.utils = h.default, window.lgData = {uid: 0};
                var i = {
                    mode: "lg-slide",
                    cssEasing: "ease",
                    easing: "linear",
                ...
                l.prototype.init = function () {
                    ...
                    if (0 < e.indexOf("lg=" + this.s.galleryId) && (s.index = parseInt(e.split("&slide=")[1], 10), h.default.addClass(document.body, "lg-from-hash"), h.default.hasClass(document.body, "lg-on") || (h.default.addClass(document.body, "lg-on"), setTimeout(function () {
                        ...
                        s.build(s.index)
                    })); else for (var t = 0; t < s.items.length; t++) !function (t) {
                    ...
                    return !!function () {
                        for (var e = ["transition", "MozTransition", "WebkitTransition", "OTransition", "msTransition", "KhtmlTransition"], t = document.documentElement, s = 0, s = 0; s < e.length; s++) if (e[s] in t.style) return !0
                    }()
                    ...
                    return l ? {youtube: l} : t ? {vimeo: t} : s ? {dailymotion: s} : e ? {vk: e} : void 0
                    ...
                    function l(e) {
                        ...
                        for (var o = window.innerWidth, d = 0; d < t.length; d++) if (parseInt(t[d], 10) > o) {
                            r = s[d];
                            break
                        }
                    }

                    var r, i, o, d, a = this, n = !1,
                    ...
                    if (!h.default.hasClass(a.___slide[t], "lg-loaded")) {
                        if (c ? a.___slide[t].insertAdjacentHTML("afterbegin", '<div class="lg-video-cont" style="max-width:' + a.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + r + '"  allowfullscreen="true"></iframe></div></div>') : n ? (c = "", c = g && g.youtube ? "lg-has-youtube" : g && g.vimeo ? "lg-has-vimeo" : "lg-has-html5", a.___slide[t].insertAdjacentHTML("beforeend", '<div class="lg-video-cont ' + c + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + i + '" /></div></div>')) : g ? (a.___slide[t].insertAdjacentHTML("beforeend", '<div class="lg-video-cont "><div class="lg-video"></div></div>'), h.default.trigger(a.el, "hasVideo", {
                            ...
                            src: r,
                            html: d
                        })) : a.___slide[t].insertAdjacentHTML("beforeend", '<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + r + '" /></div>'), h.default.trigger(a.el, "onAferAppendSlide", {index: t}), d = a.___slide[t].querySelector(".lg-object"), u && d.setAttribute("sizes", u), o) {
                    ...
                    for (var l = 0, i = 0; i < this.___slide.length; i++) if (h.default.hasClass(this.___slide[i], "lg-current")) {
                        l = i;
                        break
                    }
                    var o = this;
                    if (!o.lGalleryOn || l !== e) {
                        var d = this.___slide.length, r = o.lGalleryOn ? this.s.speed : 0, a = !1, n = !1;
                        if (!o.lgBusy) {
                    ...
                    var t = this;
                    t.lgBusy || (t.index + 1 < t.___slide.length ? (t.index++, h.default.trigger(t.el, "onBeforeNextSlide", {index: t.index}), t.slide(t.index, e, !1)) : t.s.loop ? (t.index = 0, h.default.trigger(t.el, "onBeforeNextSlide", {index: t.index}), t.slide(t.index, e, !1)) : t.s.slideEndAnimatoin && (h.default.addClass(t.outer, "lg-right-end"), setTimeout(function () {
                    ...
                    for (var l = 0; l < this.___slide.length; l++) h.default.removeClass(this.___slide[l], "lg-next-slide"), h.default.removeClass(this.___slide[l], "lg-prev-slide");
                    -1 < t && h.default.addClass(this.___slide[t], "lg-prev-slide"), h.default.addClass(this.___slide[e], "lg-next-slide")
                    ...
                    if (e || h.default.trigger(s.el, "onBeforeClose"), document.body.scrollTop = s.prevScrollTop, document.documentElement.scrollTop = s.prevScrollTop, e) {
                        if (!s.s.dynamic) for (var l = 0; l < this.items.length; l++) h.default.off(this.items[l], ".lg"), h.default.off(this.items[l], ".lgcustom");
